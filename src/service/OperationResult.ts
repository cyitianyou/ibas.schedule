...
export interface IOperationResult<P> extends IOperationMessage {
     ...
     * 返回对象
     */
    resultObjects: Array<P>;
    /**
     * 操作执行信息
     */
    informations: Array<IOperationInformation>;
}
/**
 * 操作信息
 */
...
export class OperationResult<P> extends OperationMessage implements IOperationResult<P> {
    ...
    constructor() {
        super(arguments[0]);
        this.resultObjects = new Array<P>();
        this.informations = new Array<IOperationInformation>();
    }
    /**
     * 返回对象
     */
    ...
    addResults(): void {
        ...
        if (arguments[0] instanceof Array) {
            ...
            this.resultObjects.push(arguments[0]);
        }
    }
}
